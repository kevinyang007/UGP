...
try:
	X=pickle.load(open('caltech_images.out','rb'))    # Image 
	Y=pickle.load(open('caltech_labels.out','rb'))    # Image 
	...
	for dirpath, dirnames, filenames in os.walk(rootdir):
		for file in filenames:
			...
			X.append(vector)
			Y.append(dirpath)
	pickle.dump(X,open('caltech_images.out','wb'))
	pickle.dump(Y,open('caltech_labels.out','wb'))
